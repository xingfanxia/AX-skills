...
from _lexicons import ENGINEERING_LEAK_TIER1, ENGINEERING_LEAK_TIER2  # 工程词黑名单单一真相源

REPEAT_MIN_LEN = 12
REPEAT_MIN_COUNT = 3
ADJACENT_MIN_LEN = 8

# 工程词泄漏：tier1 正文里几乎永不合法 → blocking；tier2 章节结构/歧义词 → advisory（词表共享自 _lexicons）
META_TIER1 = re.compile(ENGINEERING_LEAK_TIER1)
META_TIER2 = re.compile(ENGINEERING_LEAK_TIER2)
